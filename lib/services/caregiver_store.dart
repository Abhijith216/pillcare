  ...
  List<CaregiverAlert> _defaultAlerts() {
    ...
    return [
      CaregiverAlert(
        ...
        message: 'Missed Lisinopril 10mg dose at 1:00 PM',
      ...
      CaregiverAlert(
        ...
        type: AlertType.refillNeeded,
        message: 'Insulin refill needed — only 2 doses remaining',
      ...
      CaregiverAlert(
        ...
        patientName: 'Meena Devi',
        type: AlertType.missedDose,
        message: 'Missed Metoprolol 25mg morning dose',
      ...
      CaregiverAlert(
        ...
        type: AlertType.dispenserError,
        message: 'Smart Dispenser offline — check connection',
      ...
      CaregiverAlert(
        ...
        patientName: 'Anita Sharma',
        type: AlertType.refillNeeded,
        message: 'Lisinopril refill needed — only 3 doses remaining',
      ...
      CaregiverAlert(
        ...
        patientName: 'Meena Devi',
        type: AlertType.missedDose,
        message: 'Missed Omeprazole 20mg before breakfast',
      ...
      CaregiverAlert(
        ...
        patientName: 'Rajesh Kumar',
        type: AlertType.refillNeeded,
        message: 'Metformin refill needed — 8 doses remaining',
      ...
      CaregiverAlert(
        ...
        patientName: 'Meena Devi',
        type: AlertType.dispenserError,
        message: 'Dispenser lid left open for 10+ minutes',
  ...
  List<ChatMessage> _defaultMessages() {
    ...
    return [
      ChatMessage(
        ...
        senderName: 'You',
        text: 'Good morning! Did you take your Metformin today?',
      ...
      ChatMessage(
        ...
        senderId: 'p1',
        senderName: 'Rajesh',
        text: 'Yes, I took it after breakfast. Thank you for checking!',
      ...
      ChatMessage(
        ...
        senderName: 'You',
        text:
            'Hi Anita, I noticed you missed your afternoon dose. Everything okay?',
        isFromCaregiver: true,
        timestamp: now.subtract(const Duration(hours: 2)),
      ),
      ChatMessage(
        ...
        senderId: 'p2',
        senderName: 'Anita',
        text: 'Oh I forgot! Taking it now. Thanks for the reminder.',
        isFromCaregiver: false,
      ...
      ChatMessage(
        ...
        senderName: 'You',
        text:
            'Meena ji, your insulin supply is running low. Shall I arrange a refill?',
        isFromCaregiver: true,
