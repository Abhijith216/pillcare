...
class _AlertsScreenState extends State<AlertsScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Start/re-subscribe streams from Firestore + RTDB
    _store.refresh();
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text('Recent Alerts', style: GoogleFonts.manrope(fontSize: 26, fontWeight: FontWeight.w800, color: Theme.of(context).colorScheme.onSurface)),
                ...
                return Padding(
                  ...
                  child: FilterChip(
                    ...
                    shape: RoundedRectangleBorder(
                      ...
                      side: BorderSide(color: isSelected ? Colors.transparent : (isDark ? const Color(0xFF334155) : const Color(0xFFE2E8F0))),
                    ),
            ...
            child: ListenableBuilder(
              ...
              builder: (context, _) {
                ...
                return RefreshIndicator(
                  onRefresh: () async => _store.refresh(),
