...
class _ScheduleScreenState extends State<ScheduleScreen>
  ...
  String get _selectedDateLabel {
    ...
    return '${monthNames[_currentMonth.month]} $_selectedDay';
  }
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text('Request Approved', style: GoogleFonts.manrope(fontWeight: FontWeight.w800, fontSize: 18, color: Theme.of(ctx).colorScheme.onSurface)),
          ],
        ),
        content: Text(
